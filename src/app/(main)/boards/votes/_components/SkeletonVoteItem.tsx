function SkeletonVoteItem() {
  return (
    <li className="w-full">
      <div className="w-full h-[374px] md:h-[310px] flex flex-col justify-start items-center inline-flex transform transition-transform duration-300 ease-out rounded-xl overflow-hidden shadow-lg">
