function SkeletonVoteItem() {
  return (
    <li>
      <div className="w-[253px] h-[310px] flex-col justify-start items-center inline-flex transform transition-transform duration-300 ease-out shadow-lg">
        ...
        <div className="self-stretch grow shrink basis-0 flex-col justify-start items-start p-3 bg-gray-100 gap-2 flex">
          ...
          <div className="w-16 h-4 bg-gray-300 animate-pulse mt-6"></div>
        </div>
        <div className="self-stretch grow shrink basis-0 px-2 bg-gray-200 justify-center items-center gap-3 flex">
